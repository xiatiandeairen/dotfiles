...
software_list=("zsh" "stow" "git" "tig" "curl" "wget" "vim" "nvim" "emacs" "fzf" "bat" "eza" "tldr" "broot" "thefuck" "tmux" "htop" "zoxide" "w3m" "s-search" "jq" "ack" "fd" "kitty" "direnv" "rg" "ripgrep" "the_silver_searcher" "perl" "nvm" "pyenv")
